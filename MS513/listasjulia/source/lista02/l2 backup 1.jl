...
#=╠═╡
function extend_croped(M::AbstractMatrix, l, r)
	N = [[extend(M[i,j]) for j in -r:r] for i in -l:l]
	return N
end
  ╠═╡ =#

# ╔═╡ 08674486-6321-4692-8fbf-a2d9289d7ed8
#=╠═╡
function ExtractRange(M::AbstractMatrix, a::Int32, b::Int32, c::Int32, d::Int32)
	if (0<a<b<=size(M, 1))&&(0<c<d<=size(M,2))
		return copy(M[a:b,c:d])
	else
		[extend]
	end
end
