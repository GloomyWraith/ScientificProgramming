...
md"👉 Defina `a_rand` como um vetor aleatório usando `random_vect` e o valor `m` como sua média."
...
# ╔═╡ 8a693220-655b-463b-98ef-548465514879
lado = ones(40)
...
A imagem se torna irreconhecível a partir de 85% de intensidade, sendo presevada apenas a silhueta de regiões grandes com alto contraste. Com 95%, mesmo essa informação parece se perder e vemos praticamente apenas ruído. Não foi necessária intensidade maior que 1.
"""
